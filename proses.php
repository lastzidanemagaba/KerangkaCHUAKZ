...
$sql_user = $pdo->prepare("SELECT nama_lengkap,id,username FROM user_list WHERE user_list.id_level = '4' ORDER BY id ASC;");
$sql_user->execute();

$no = 1; // Untuk penomoran tabel, di awal set dengan 1
$row = 3; // Set baris pertama untuk isi tabel adalah baris ke 4
// agar loop bisa berulang denga normal
$dt = $sql_user->fetchAll();
$dt2 = $sql->fetchAll();

foreach ($dt as $data) { // Ambil semua data dari hasil eksekusi $sql_user
